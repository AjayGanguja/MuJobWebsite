...
{
    [Authorize]// force to login or register but allow for all roles
    [Authorize(Roles = "Admin")] // allow to users only with that role and  force to login
    //[Authorize(Users  = //"user name"] allow to specific user and  force to login
